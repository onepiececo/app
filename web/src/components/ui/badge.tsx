...
export const badgeVariants = tv({
  base: "inline-flex items-center gap-x-1.5 rounded-md px-2 py-0.5 text-xs font-semibold transition-[background-color,color,box-shadow] duration-[120ms] ease-out focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 [&_svg:not([class*='size-'])]:size-3.5 [&_svg:not([class*='opacity-'])]:opacity-90 [&_svg]:pointer-events-none [&_svg]:shrink-0 [button&,a&]:cursor-pointer",
});
...
export function Badge({
  ...
  const defaultProps = {
    className: badgeVariants({ class: `${surface} ${className ?? ""}` }),
    "data-slot": "badge",
