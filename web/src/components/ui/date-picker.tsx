...
export const datePickerVariants = tv({
  slots: {
    trigger: "w-65 justify-start font-normal",
    popoverBody: "",
  },
  variants: {
    beforeCalendar: {
      true: {
        popoverBody: "flex max-sm:flex-col",
      },
      false: {},
    },
  },
  defaultVariants: {
    beforeCalendar: false,
  },
});
...
export const DatePicker = (props: DatePickerProps) => {
  ...
  const styles = datePickerVariants({
    beforeCalendar: !!props.beforeCalendar,
  });
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger
        ...
        render={
          <Button
            className={styles.trigger({ class: props.triggerClassName })}
