...
export const buttonVariants = tv({
  base: "group/button relative inline-grid shrink-0 cursor-pointer place-items-center whitespace-nowrap rounded-lg border border-transparent font-semibold text-base outline-none transition-[box-shadow,transform,background-color,border-color,color,filter] duration-[120ms] ease-out pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background active:not-disabled:translate-y-px data-pressed:not-disabled:translate-y-px disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none disabled:inset-shadow-none data-loading:select-none sm:text-sm [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:-mx-0.5 [&_svg]:shrink-0",
  defaultVariants: {
    size: "default",
    variant: "default",
  },
